        ...
        <form action="{{ route('admin.items.store') }}" method="post" class="pt-3 pb-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" id="slug"
                    aria-describedby="helpId" placeholder="" value="{{ old('slug') }}" required />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('category') is-invalid @enderror" name="category"
                    id="category" aria-describedby="helpId" placeholder="" value="{{ old('category') }}" />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('weight') is-invalid @enderror" name="weight"
                    id="weight" aria-describedby="helpId" placeholder="" value="{{ old('weight') }}" />
